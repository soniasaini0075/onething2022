...
const BangaloreSpace = () => {
  ...
  return (
    ...
    <h1 class="newh1">Leading UI UX Design Company in Bangalore</h1>
    ...
    <section class="design-with-purpose-wrapper blur-overlay">
    <div class="div-wrap">
    <div class="container">
    <div className="grad type-2 small gr-box2"></div>
    <div className="grad type-2 medium gr-box2"></div>
    <div class="heading-wrapper">
    <h2 class="newh2 section-heading">We design with purpose, for better conversions</h2>
